// c++ -o epem_02 `root-config --glibs --cflags` -lm epem_02.cpp
// ./epem_02 LHE_withHiggs.lhe LHE_withoutHiggs.lhe
// ./epem_02 ../VBF_epem/Events/run_01/events.lhe  
      ...
      for (int iPart = 0 ; iPart < reader.hepeup.IDUP.size (); ++iPart)
        {
          ...
          //PG leptons
          if (abs (reader.hepeup.IDUP.at (iPart)) == 25)  //PG W
            {
...
//                   << "\n" ;
  ...
  TFile outfile ("epem_02.root", "recreate") ;
  h_mH.Write () ;
  outfile.Close () ;
