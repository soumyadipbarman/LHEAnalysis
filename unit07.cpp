...
// c++ -o unit07 `root-config --glibs --cflags` -lm hFactory.cc hChain.cc h2Factory.cc h2Chain.cc unit07.cpp
...
int main (int argc, char **argv) {
  ...
  H1fact.add_h1 ("tags_Deta","jet tags Deta", 200, 0, 7, 3) ;
  H1fact.add_h1 ("tags_phi", "tags_phi", 200, -7, 7, 3) ;
  H1fact.add_h1 ("tags_Dphi","jet tags Dphi", 200, 0, 3.15, 3) ;
  ...
  H1fact.add_h1 ("leps_Deta","leps Deta", 200, 0, 7, 3) ;
  H1fact.add_h1 ("leps_phi", "leps phi", 200, -7, 7, 3) ;
  H1fact.add_h1 ("leps_Dphi","jet leps Dphi", 200, 0, 3.15, 3) ;
  H1fact.add_h1 ("Vs_Deta","vector bosons Deta", 200, 0, 7, 3) ;

  h2Factory H2fact ("output2D.root", true) ;

  H2fact.add_h2 ("tags_pt_vs_zep","jet tags pt vs zeppenfeld var",  25,-7,7,25,0,300, 3) ;
  H2fact.add_h2 ("tags_maxPt_vs_Deta","jet tags max pt vs delta eta var", 25,0,7,25,0,300, 3) ;
  H2fact.add_h2 ("tags_Mtot_vs_Deta","final state total M vs delta eta", 25,0,7,25,0,3000, 3) ;
  H2fact.add_h2 ("tags_eta1_vs_eta2","jet tags eta 1 vs eta 2", 25,-7,7, 25,-7,7, 3) ;
  H2fact.add_h2 ("tags_z1_vs_Deta","jet tags zeppenfeld high p vs Deta", 25,0,7, 25,-7,7, 3) ;
  H2fact.add_h2 ("tags_z2_vs_Deta","jet tags zeppenfeld low p vs Deta", 25,0,7, 25,-7,7, 3) ;
  H2fact.add_h2 ("Peta_vs_Deta","jet tags eta product vs Deta", 25,0,7, 25,-10,10, 3) ;
  H2fact.add_h2 ("Dphi_vs_Deta","jet tags Dphi vs Deta", 25,0,7, 25,0,3.15, 3) ;
  H2fact.add_h2 ("DetaL_vs_DetaJ","leptons Deta vs jet tags Deta", 25,0,7, 25,0,7, 3) ;
  H2fact.add_h2 ("PhiZ_vs_PhiV","phi of lept Z vs phi of hadronic V", 25,-3.15,3.15, 25,-3.15,3.15, 3) ;
  H2fact.add_h2 ("EtaZ_vs_EtaV","eta of lept Z vs eta of hadronic V", 25,-7,7, 25,-7,7, 3) ;
...
//  H1fact["tags_zep"]->Print (0,2,"tags_zep_bin") ;
  ...
  int colors2[3] = {9,98,14} ;
  H2fact.applyToAll (setH2Colors (std::vector<int> (colors2, colors2 + 3))) ;
