...
/*
  c++ -o testPowhegCPS `root-config --glibs --cflags` \
     -lm testPowhegCPS.cpp
*/
...
struct ptSort: public std::binary_function<const TLorentzVector &, const TLorentzVector &, bool>
{
...
int main (int argc, char **argv) 
{
  ...
  map<string, TH1F *> hmap_V1 = 
    readSample ("/afs/cern.ch/user/g/govoni/work/HIGGS_MC/2015-10-21-CPS/result_CPS/pwgevents.lhe", "V1", N1_tot) ;

  int N2_tot = 1000000 ;
  map<string, TH1F *> hmap_V2 = 
    readSample ("/afs/cern.ch/user/g/govoni/work/HIGGS_MC/2015-10-21-CPS/result_narrow/pwgevents.lhe", "V2", N2_tot) ;

  TFile outfile ("testPowhegCPS.root", "recreate") ;
  ...
  string outFolderName = "testPowhegCPS_plots/";
